...
+ [fork](https://docs.github.com/en/get-started/quickstart/fork-a-repo) and check out your forked repository. If you don't have a GitHub account, you can still clone the Commons repository.
